...
The basic idea is to parse the [Portable Executable](https://learn.microsoft.com/en-us/windows/win32/debug/pe-format) format, and find the CLI header extension that will point us to the CLI metadata.  We only care about a few other bits.  
