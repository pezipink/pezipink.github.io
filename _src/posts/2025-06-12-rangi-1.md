...
Carrying on from the [last post](https://pinksquirrellabs.com/blog/2025/06/04/flat-resurrection/), let's look at reading the data from a Windows .exe or .dll file that has been compiled a CLI tool (ilasm, F#, C#, etc).
