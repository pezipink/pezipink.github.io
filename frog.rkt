...
(define/contract (init)
  (-> any)
  (current-scheme/host "http://www.pinksquirrellabs.com")
  (current-uri-prefix "/")
  (current-title "Pink Squirrel Labs")
  (current-author "pezi")
...
(define/contract (enhance-body xs)
  ...
  (~> xs
      (syntax-highlight #:python-executable "C:\\Users\\juan\\AppData\\Local\\Programs\\Python\\Python36-32\\python.exe "
                        #:line-numbers? #t
                        #:css-class "highlight")
